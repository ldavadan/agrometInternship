...
In the case of the project, the nested data frame contains one row for each hour which in turns contains a nested data frame holding the data from all the stations for this hour. In the Table \@ref(tab:ndf), there is a preview of the data frame contained into each row.
